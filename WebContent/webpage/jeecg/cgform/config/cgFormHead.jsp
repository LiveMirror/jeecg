	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value"><select id="isTree" name="isTree">
				<option value="N" <c:if test="${cgFormHeadPage.isTree eq 'N'}"> selected='selected'</c:if>><t:mutiLang langKey="common.yes"/></option>
			...
			<td class="value"><select id="isPagination" name="isPagination">
				...
				<option value="N" <c:if test="${cgFormHeadPage.isPagination eq 'N'}"> selected="selected"</c:if>><t:mutiLang langKey="common.yes"/></option>
			</select></td>
		</tr>
		<tr>
			...
			<td class="value"><select id="isCheckbox" name="isCheckbox">
				<option value="N" <c:if test="${cgFormHeadPage.isCheckbox eq 'N'}"> selected="selected"</c:if>><t:mutiLang langKey="common.yes"/></option>
